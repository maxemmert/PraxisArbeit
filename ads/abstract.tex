...
\newline
In this work it is studied how to integrate plug-ins into an existing Eclipse \ac{RCP} application. In particular, the graphic integration into the existing software construct is in the foreground. The design and implementation of a plug-in in the \ac{RCP} environment is also part of the core of this work. Besides the basics of Eclipse \ac{RCP} development related issues such as \ac{OSGi} are treated.
